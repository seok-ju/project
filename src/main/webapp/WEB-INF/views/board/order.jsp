...
<table>
	<tr>
		<td><a href="<c:url value="상품페이지" />">상품페이지</a></td>
		<td><a href="<c:url value="장바구니" />">장바구니</a></td>
		<td><a href="<c:url value="관리페이지" />">관리페이지</a></td>
		<td><a href="<c:url value="고객센터" />">고객센터</a></td>
	</tr>
	<tr>
		<th>쇼핑몰이름</th>
	</tr>
	...
	<table>
	<tr>
	<td><input type="text" name="id" width="100"></td><td><input type="password" name="pw" width="100"></td>
	<td><input type="button" name="rogin" value="로그인" ></td><td><input type="button" name="join" value="회원가입" ></td>
	<td><input type="text" name="info" width="100"></td><td><input type="button" name="Search" value="검색" ></td>
	</tr>
	</table>
	<table>
	...
	<table>
	<tr><th>주문정보</th></tr>
	<tr><th>주문하시는분</th><td><input type="text" id="name" name="name" width="100" value = "${member.name}"></td></tr>
	<tr><th>휴대전화</th><td><input type="number" id="num"name="num" width="100" value = "${member.phone}"></td></tr>
	<tr><th>이메일</th><td><input type="email"  id="mail"name="mail" width="100" value = "${member.email}"></td></tr>
	<tr><th>주소</th><td><input type="text" id="sample4_postcode" placeholder="우편번호" value = "${addr1}"></td>
	...
	<table>
	<tr><th>배송정보</th></tr>
	<tr><th>배송지선택</th><td><input type="radio" name="ch1"  value="기본" onclick="transfer(1);">주문자 정보와 동일
	<input type="radio" name="ch1"  value="기본" checked="checked" onclick="transfer(0);">새로운 배송지</td></tr>
	<tr><th>주문하시는분</th><td><input type="text" id="name1" name="name" width="100"></td></tr>
	<tr><th>휴대전화</th><td><input type="number"id="num1" name="num" width="100"></td></tr>
	<tr><th>이메일</th><td><input type="email"id="mail1" name="mail" width="100"></td></tr>
	<tr><th>주소</th><td><input type="text" id="postcode" placeholder="우편번호"></td>
					<td><input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br></td>
					</tr>
	<tr>
		<td><span id="guide" style="color:#999;display:none"></span></td>
	...
	<br>
	<tr><th>적립금 사용</th><td><input type="text" name="ad" width="100" value="원"></td></tr>
	<br>
	<br>
	<table>
		<th>결제예정금액</th>
